...
alert("Warning! This message will self-destruct in 3!!!!")
alert("Warning! This message will self-destruct in 2!!!!")
alert("Warning! This message will self-destruct in 1!!!!")
